...
export default function AdminSettingsPanel({
  ...
  const inputBase =
    "w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-800 outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-400/10";
    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-7">
      ...
      >
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          ...
          <label className="mt-5 flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-amber-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-amber-700">
        ...
        <div className="grid gap-5">
          ...
          <div className="flex justify-end pt-2">
            <button
              type="submit"
              disabled={isSaving}
              className="flex items-center gap-2 rounded-xl bg-amber-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-700 disabled:cursor-not-allowed disabled:opacity-60"
            >
