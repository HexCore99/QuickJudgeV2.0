...
// ── Inline Reply Form ──────────────────────────────────────
function InlineReplyForm({ discussionId, parentReplyId, authorName, onClose }) {
...
function ReplyNode({ node, discussionId, depth, user }) {
  ...
  function handleDelete() {
    dispatch(deleteReplyThunk({ discussionId, replyId: node.id }));
  }
...
export default function DiscussionDetail() {
  ...
  function handleDeleteDiscussion() {
    dispatch(deleteDiscussionThunk(discussion.id));
  }
